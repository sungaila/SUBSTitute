...
public partial class HackedCollectionView : IAdvancedCollectionView, INotifyPropertyChanged, ISupportIncrementalLoading, IComparer<object>
{
    ...
    private WeakEventListener<HackedCollectionView, object, NotifyCollectionChangedEventArgs> _sourceWeakEventListener;

    /// <summary>
    /// Initializes a new instance of the <see cref="HackedCollectionView"/> class.
    /// </summary>
    public HackedCollectionView()
        ...
        set
        {
            ...
            if (_source is INotifyCollectionChanged sourceNcc)
            {
                _sourceWeakEventListener =
                    new WeakEventListener<HackedCollectionView, object, NotifyCollectionChangedEventArgs>(this)
                    {
